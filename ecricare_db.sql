...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=4187459452ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ecricare_db&table=patients">`ecricare_db`.`patients`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=loginsystem&table=users">`loginsystem`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=register&table=users">`register`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=loginform&table=login">`loginform`.`login`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=+phplogin&table=patients">` phplogin`.`patients`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=+phplogin&table=contacts">` phplogin`.`contacts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=vital&table=admin">`vital`.`admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=vital&table=patients">`vital`.`patients`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=clinic&table=tbl_userlogs">`clinic`.`tbl_userlogs`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=csv_db+12&table=consultation">`csv_db 12`.`consultation`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="705f7e524044476d5e462324345b4b75">
